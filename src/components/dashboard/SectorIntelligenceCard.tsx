...
export default function SectorIntelligenceCard({ sector, displayMode, dataSource = 'combined' }: SectorIntelligenceCardProps) {
  ...
  return (
    <Card className="bg-gradient-to-br from-orange-600 via-orange-700 to-red-700 border-2 border-orange-600 hover:border-red-700 hover:shadow-2xl transition-all duration-300 group relative overflow-hidden">
